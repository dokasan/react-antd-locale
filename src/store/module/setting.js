...
class Setting {
  ...
  // 默认语言
  @observable currLocale = localStorage.getItem('currLocale') ? localStorage.getItem('currLocale') : Configure.currLocale

  @action
  changeCurrLocale = currLocale => {
    localStorage.setItem('currLocale', currLocale)
